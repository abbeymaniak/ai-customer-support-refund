...
class LLMProvider(Base):
    ...
    llm: Mapped[str] = mapped_column(String(32), unique=True, index=True, nullable=False)
    ...
    updated_by: Mapped[str | None] = mapped_column(String(128), default="system", nullable=True)
